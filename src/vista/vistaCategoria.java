...
public class vistaCategoria extends JDialog {
	...
	public JTextField txtId, txtCategoria;
	...
	public vistaCategoria() {
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(vistaCategoria.class.getResource("/Img/categoria64.png")));
		setTitle("Categorias");
		...
		lblNewLabel_1.setIcon(new ImageIcon(vistaCategoria.class.getResource("/Img/2categorias64.png")));
		lblNewLabel_1.setBounds(289, 25, 96, 87);
